	...
	return (
		<>
			<Comment
				...
				setDeleteComponentModalIsOpen={setDeleteComponentModalIsOpen}
			...
			<ModalNoYes
				...
				setDeleteComponentModalIsOpen={setDeleteComponentModalIsOpen} deleteComponentModalIsOpen={deleteComponentModalIsOpen}
			/>
		</>
	)
}
